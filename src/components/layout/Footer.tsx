...
import { Mail, Code2, ArrowUpRight, Globe } from "lucide-react";
import { socialLinks } from "@/data";

// Use SVG inline for brands not in lucide-react v1.x
            ...
            <ul className="space-y-2">
              {footerLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-text-secondary text-sm hover:text-accent transition-colors hover-underline"
                  >
                    {link.label}
                  </a>
                </li>
